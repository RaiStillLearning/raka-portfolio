...
const Icons = {
  gitHub: () => (
    <svg width="40" height="40" viewBox="0 0 438.549 438.549">
      <path
        fill="currentColor"
  ...
  return (
    <div className="min-h-screen py-20">
      <div className="header-text">
        ...
        <div className="about-me-text max-w-2xl mx-auto mt-6 px-4">
      ...
      {/* ✅ FIX: Wrapper untuk centering */}
      <div className="flex justify-center items-center mt-20 min-h-[600px]">
        <div className="relative flex h-[500px] w-[500px] items-center justify-center">
          {/* ✅ INNER ORBIT - 3 icons dengan delay berbeda */}
          <OrbitingCircles
          ...
          {/* ✅ OUTER ORBIT - 4 icons reverse dengan delay berbeda */}
          <OrbitingCircles
            className="size-[50px] border-none bg-transparent"
            radius={200}
            duration={30}
